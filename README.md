...
Smart Interview Bot is an AI-powered web application that helps candidates practice for job interviews. It generates tailored interview questions based on job title, experience, and resume, provides real-time feedback, and analyzes candidate responses using AI and emotion detection.

## Features

- **AI-Generated Interview Questions:**  
  Generate technical, behavioral, and scenario-based questions based on job title, experience, and language preference (English/Urdu).

- **Resume Parsing:**  
  Upload your resume (PDF/DOCX) to generate personalized questions.

- **Real-Time Feedback:**  
  Get instant AI feedback on your answers using Gemini or static datasets.

- **Emotion Detection:**  
  Analyze candidate emotions during the interview using DeepFace.

- **Voice Support:**  
  Listen to questions and answer using voice input.

- **Admin Panel:**  
  View interview logs and contact messages from candidates.

- **Contact Form:**  
  Candidates can send messages to the admin, which are stored and viewable in the admin panel.

## Tech Stack

- **Backend:** FastAPI (Python)
- **Frontend:** HTML, CSS, JavaScript (Jinja2 templates)
- **AI/ML:** Google Gemini API (or static fallback), DeepFace
- **Database:** JSON files for logs and messages (easy to migrate to a real DB)
- **Other:** PyMuPDF, pdfplumber, pydantic, uvicorn
...
4. **Set up your Gemini API key (optional):**
    - Add your Gemini API key in `.env` or directly in `utils/gemini_api.py`.
...
- **Candidate:**  
  1. Fill in your details and upload your resume.
  2. Generate interview questions and practice answering.
  3. Receive instant feedback and emotion analysis.
  4. Submit your interview log or contact the admin for help.

- **Admin:**  
  - View all interview logs and contact messages from the admin panel.

## Customization

- To use static questions instead of Gemini API, update `utils/gemini_api.py` as described in the code comments.
- To add more job titles or question types, edit the static dataset or improve the prompt logic.

## License

This project is for educational/demo purposes.  
If you use third-party models (like DeepFace or Gemini), please check their licenses.

---

**Developed by Uzair Arif and contributors.**
